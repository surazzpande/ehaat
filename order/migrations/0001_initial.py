# Generated by Django 3.2.4 on 2021-12-08 03:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='EhatBazzar.account')),
            ],
        ),
        migrations.CreateModel(
            name='OrderProduct',
        ...
        migrations.AddField(
            model_name='order',
            name='user',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='EhatBazzar.account'),
        ),
    ]
